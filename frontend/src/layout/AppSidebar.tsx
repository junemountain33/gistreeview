...
const navItems: NavItem[] = [
  {
    ...
    roles: ["admin"],
    subItems: [
      { name: "Input Data Admin", path: "/admin/datainput", pro: false },
      { name: "Data User", path: "/admin/datauser", pro: false },
      { name: "Data Tree", path: "/admin/datatree", pro: false },
      { name: "Data Road", path: "/admin/dataroad", pro: false },
    ],
  },
  {
    icon: <UserCircleIcon />,
  ...
  },
  {
    ...
    subItems: [
      { name: "Edit Profile", path: "/user/editprofile", pro: false },
      { name: "Report Data User", path: "/user/reportdata", pro: false },
    ],
  },
  {
    icon: <UserCircleIcon />,
