...
const RoadModal: React.FC<RoadModalProps> = ({
  open,
  roadName,
  roadId,
  treeCount,
  ...
  return (
    <div className="absolute left-4 bottom-14 z-[9999]">
      <div className="bg-white rounded-xl shadow-lg p-6 min-w-[300px] relative border border-gray-300">
        <button
        ...
        <div className="flex items-center gap-2 text-base text-gray-700 mt-2">
          ...
          <TreeTreeView className="w-6 h-6 text-green-700" />
